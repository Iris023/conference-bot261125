...
bot.start(async (ctx) => {
  ...
  const text =
    '<b>Здравствуйте!</b>\n' +
    'Рады приветствовать вас в чат-боте Конференции «Производительность у моря», ' +
    'посвященной итогам и перспективам развития бережливого производства в Дальневосточном регионе.\n\n' +
    '<b>О МЕРОПРИЯТИИ</b>\n' +
    'Дата: 26 ноября 2025 г. (среда)\n' +
    'Место проведения: ул. Батарейная, 4, филиал национального центра «Россия» в Приморском крае (бывший Океанариум)\n\n' +
    '<b>Ключевые темы дня:</b>\n' +
    '• Награждение лучших участников национального и федерального проектов «Производительность труда».\n' +
    '• Презентация успешных кейсов и лучших практик повышения производительности в компаниях Приморья.\n' +
    '• Обмен опытом для роста эффективности ваших предприятий.\n' +
    '• Актуальные меры государственной поддержки и новые возможности для сотрудничества с органами власти.\n\n' +
    '<b>Участники встречи:</b>\n' +
    'Губернатор ПК О.Н. Кожемяко, зампред правительства ПК Н.И. Стецко, министр экономики ПК А.И. Блохин, ' +
    'руководители центра «Мой бизнес», РЦК и ведущих предприятий края.\n\n' +
    'Условия участия: <b>бесплатно</b>.\n' +
